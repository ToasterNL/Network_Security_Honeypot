...
We are also going to filter outgoing SMTP, SIP and NetBIOS.
...
Unfortunately exploits are frequently found for Wordpress and patches are published on a regular basis. 
We plan to use an older version of Wordpress, for example a version below version 3.0.4, to be sure that we use a version with some exploits.
