...
Snort is rule-based and we intend to setup snort using a predefined rules-set that will only alert to suspicious network behaviour and do nothing to prevent it. 
